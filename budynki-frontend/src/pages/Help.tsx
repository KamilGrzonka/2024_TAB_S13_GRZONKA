...
const Help = () => {
  ...
  const images_registration = [
    ...
    { src: meldunkilista, alt: 'Lista meldunków', description: 'Z poziomy listy meldunków możliwe jest dodanie nowego meldunku poprzez kliknięcie przycisku "Dodaj meldunek" lub przejście do szczegółów danego meldunku klikając w odpowiednią komórkę kolumny "Szczegóły". ' },
  ...
  const images_repairs = [
    ...
    { src: zgloszenialista, alt: 'Lista zgłoszeń', description: 'Z poziomy listy zgłoszeń możliwe jest dodanie nowego zgłoszenia poprzez kliknięcie przycisku "Dodaj zgłoszenie" lub przejście do szczegółów danego zgłoszenia klikając w odpowiednią komórkę kolumny "Szczegóły". ' },
  ...
  const description_companies = 'Po dodaniu do systemu zgłoszeń oraz poszczególnych zadań zalecane jest dodanie form podwykonawczych, które można przypisać do zadań. W tym celu zalecane jest przejście do zakładki "Firmy", po otworzeniu której wyświetlona zostanie lista zarejestrowanych firm w systemie:';
  ...
  const images_reports = [
    ...
    { src: raportzarzadczy, alt: 'Raport zarządczy', description: 'Wybranie opcji "Wygeneruj Raport Zarządczy" z poprzedniego widoku, sprawi że wyświetlony widok z zyskami pochodzącymi z poszczególnych budynków zarejestrowanych w systemie.' },
